...
public class Qatar2022revision {
        ...
        while(exit == false){
            ...
            if(userChoice == 1){
               ...
               if(teamIndex == -1){
                ...
                for(int i= 0; i<groupA.getNumberOfTeams(); i++){
                    for(int j=0; j<groupA.getTeams()[i].getSquad().size(); j++){
                        if(groupA.getTeams()[i].getSquad().get(j).getMarketValue() > highestMarketValue){
                            highestMarketValue = groupA.getTeams()[i].getSquad().get(j).getMarketValue();
                            mvp = groupA.getTeams()[i].getSquad().get(j);
                        }
                    }
                }
